This add-on allows you to select vertices based on their position relative to the world axes. For example, you can easily select all vertices on the positive X side of the scene.
